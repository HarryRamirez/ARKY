...
public class QuotationServiceImpl implements QuotationService{
    ...
    @Transactional // Asegúrate de que las operaciones se realicen en una sola transacción
	...
	@Override
	public List<Quotation> searchQuotation(String customerName) {

		return quotationRepository.findByCustomerName(customerName);
	}
